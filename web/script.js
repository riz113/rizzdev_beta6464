/* ====================================================
   ...
   script.js - Versi Terbaru (Full Fitur)
   ==================================================== */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // =============================================
    //  10. DOWNLOAD CV (Tetap pakai link langsung)
    // =============================================
    // Tidak perlu event listener tambahan, karena link sudah langsung mengarah ke Google Drive
    ...
    // =============================================
    //  12. LANGUAGE SWITCH (Bahasa) + Placeholder Form
    // =============================================
    ...
    if (languageBtn) {
        languageBtn.addEventListener('click', function() {
            ...
            this.innerHTML = (currentLanguage === 'id') ? '🇮🇩' : '🇬🇧';

            // Ganti teks semua elemen dengan atribut data-lang
            ...
            // Ganti placeholder pada input dan textarea
            document.querySelectorAll('input[data-lang-id-placeholder], textarea[data-lang-id-placeholder]').forEach(function(el) {
                const idPlaceholder = el.getAttribute('data-lang-id-placeholder');
                const enPlaceholder = el.getAttribute('data-lang-en-placeholder');
                el.placeholder = (currentLanguage === 'id') ? idPlaceholder : enPlaceholder;
            });
        });
    }
    ...
    // =============================================
    //  15. CUSTOM CURSOR (Tetap muncul di semua perangkat)
    // =============================================
    ...
    if (cursorDot && cursorOutline) {
        ...
        // Sembunyikan saat keluar window (tetap muncul saat di dalam)
        ...
        // HAPUS aturan yang menyembunyikan cursor di touch device
        // (sekarang cursor akan tetap muncul di semua perangkat)
    }
